...
Perfil `full` · Ubuntu 26.04 LTS · Node v22.22.1 · 6.7 min · ADRs A03, A05, A06
...
| | Critério | Medido |
|---|---|---|
| **OK** A1 | **zero** perda de operação confirmada, em todos os pontos de kill e na vazão | matriz: 0 perdidas em 27 casos (12 com morte real) · vazão: 0 perdidas em 100000 |
...
| **OK** A4 | nenhum item commitado da outbox perdido em **nenhum** ponto de kill; o boot sempre converge | 27/27 convergiram · queimados por crash entre reserva e commit: 0 (§7.5 permite) |
...
| **OK** A6 | p95 de submissão dentro de 60 ms com group commit (§26.1; se falhar, renegocia-se o alvo, nunca a barreira) | p50=0.1875ms p95=0.34375ms p99=0.375ms · grupo médio 30.8, máx 32 · enfileiramento FULL 0.14ms/op · WAL manifest 4169472B |
| **OK** A7 | nenhuma dependência de shutdown limpo para durabilidade — todo caso é `SIGKILL` | 12 casos com morte real por SIGKILL, todos recuperados sem close nem checkpoint |
...
|---|---|---|---|---|---|---|
| `sem-kill` | false | 0 | 0 | 200 | 0 | true |
| `sem-kill` | false | 0 | 0 | 200 | 0 | true |
| `sem-kill` | false | 0 | 0 | 200 | 0 | true |
| `host:before-append` | true | 0 | 0 | 200 | 0 | true |
| `host:before-append` | true | 0 | 0 | 200 | 0 | true |
| `host:before-append` | true | 0 | 0 | 200 | 0 | true |
| `host:after-append-before-ack` | true | 0 | 0 | 200 | 0 | true |
| `host:after-append-before-ack` | true | 0 | 0 | 200 | 0 | true |
| `host:after-append-before-ack` | true | 0 | 0 | 200 | 0 | true |
| `client:after-ack-before-persist` | true | 0 | 0 | 200 | 0 | true |
| `client:after-ack-before-persist` | true | 0 | 0 | 200 | 0 | true |
| `client:after-ack-before-persist` | true | 0 | 0 | 200 | 0 | true |
| `client:after-persist` | true | 0 | 0 | 200 | 0 | true |
| `client:after-persist` | true | 0 | 0 | 200 | 0 | true |
| `client:after-persist` | true | 0 | 0 | 200 | 0 | true |
| `client:between-view-and-manifest` | false | 0 | 0 | 200 | 0 | true |
| `client:between-view-and-manifest` | false | 0 | 0 | 200 | 0 | true |
| `client:between-view-and-manifest` | false | 0 | 0 | 200 | 0 | true |
| `client:during-checkpoint` | false | 0 | 0 | 200 | 0 | true |
| `client:during-checkpoint` | false | 0 | 0 | 200 | 0 | true |
| `client:during-checkpoint` | false | 0 | 0 | 200 | 0 | true |
| `client:before-enqueue-commit` | false | 0 | 0 | 200 | 0 | true |
| `client:before-enqueue-commit` | false | 0 | 0 | 200 | 0 | true |
| `client:before-enqueue-commit` | false | 0 | 0 | 200 | 0 | true |
| `client:after-enqueue-commit` | false | 0 | 0 | 200 | 0 | true |
| `client:after-enqueue-commit` | false | 0 | 0 | 200 | 0 | true |
| `client:after-enqueue-commit` | false | 0 | 0 | 200 | 0 | true |
